			...
			<div>
				...
				<span class="gkTweetName">
						<?php if($this->config['twitter_show_uname']) : ?>
							<a href="<?php echo 'https://twitter.com/'.$this->pData[$i]['url']; ?>" target= "_blank"><?php echo $this->pData[$i]['username']; ?></a>
						<?php endif; ?>
						<?php if($this->config['twitter_show_uname']) : ?>
				...
				<?php if($this->config['twitter_show_actions']) : ?>
					<a class="reply" href="https://twitter.com/intent/tweet?in_reply_to=<?php echo $this->pData[$i]['id']; ?>" target= "_blank"><?php echo JText::_( 'MOD_SOCIAL_REPLY' ) ?></a>
					<a class="retweet" href="https://twitter.com/intent/retweet?tweet_id=<?php echo $this->pData[$i]['id']; ?>" target= "_blank"><?php echo JText::_( 'MOD_SOCIAL_RETWEET' ) ?></a>
					<a class="favorite" href="https://twitter.com/intent/favorite?tweet_id=<?php echo $this->pData[$i]['id']; ?>" target= "_blank"><?php echo JText::_( 'MOD_SOCIAL_FAVORITE' ) ?></a>
				<?php endif; ?>
