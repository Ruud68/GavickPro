	...
	<div class="gkIsImageWrapper">
		...
		<div class="figure<?php echo $x == 0 ? ' active': ''; ?>">
			...
			<div class="figcaption">
				...
				<h3><a href="<?php echo $link; ?>"><?php echo NSP_GK5_Utils::cutText($title, 0, $this->config['config']->gk_shop_and_buy->gk_shop_and_buy_title_block_length); ?></a></h3>
				<?php endif; ?>

				<?php if($this->config['config']->gk_shop_and_buy->gk_shop_and_buy_show_text_block) : ?>
				<p><a href="<?php echo $link; ?>"><?php echo NSP_GK5_Utils::cutText($text, 0, $this->config['config']->gk_shop_and_buy->gk_shop_and_buy_text_block_length); ?></a></p>
				<?php endif; ?>
			</div>
			<?php endif; ?>
		</div>
