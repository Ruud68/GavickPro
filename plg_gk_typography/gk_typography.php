...
class plgButtonGK_Typography extends JPlugin {
    ...
    function onDisplay($name) {
    	if(JFactory::getApplication()->input->get('option') == 'com_content' || JFactory::getApplication()->input->get('option') == 'com_k2') {
	        ...
	        $doc = JFactory::getDocument();
	     	...
	     	if (version_compare(JVERSION, '4.0', 'ge')) {
		     	$doc->addScript(JURI::root().'plugins/editors-xtd/gk_typography/gk_typography/js/gk_typography_j4.js', "text/javascript");
	     	} else
	        ...
	        $button->set('modal', version_compare(JVERSION, '4.0', 'ge'));
	        
	        $button->set('class', 'btn btn-info gktypoButton');

			// set link to # and using SqueezeBox
			$button->set('link', '#');
			if (version_compare(JVERSION, '4.0', 'ge'))
				$button->set('onclick', ' return false;$(\'#GKTypographyModal\').modal(\'show\'); ');
			else
				$button->set('onclick', ' SqueezeBox.setContent(\'clone\', jQuery(\'.gk_typography_content\')); return false; ');
...
// 	        $button->set('options', "{handler:'clone',target:$$('.gk_typography_content')[0],size:{x:400,y:400}}");
			...
			if (!version_compare(JVERSION, '4.0', 'ge'))
		        ...
		        echo '
		        <!-- The Modal -->
				<div class="joomla-modal modal fade" id="GKTypographyModal">
				  <div class="modal-dialog modal-lg jviewport-width80">
					<div class="modal-content">
					  ...
					  <div class="modal-body jviewport-height70">
						<div class="gk_typography_content">' . $generated_content . '</div>
					  </div>
